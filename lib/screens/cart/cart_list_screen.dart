      ...
      body: SafeArea(child: Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 20,),
            Expanded(
              child: ListView.builder(itemCount:cartProvider.cartList.length,itemBuilder: (context,index){
            ...
            child: Padding(
              ...
              child: Column(
                ...
                Row(
                  ...
                  GestureDetector(child: Icon(Icons.delete,size: 25,color: Colors.red,),)
                ],),
                  SizedBox(height: 8,),
                  Text(product.category,style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500,color: Colors.black45),),
                  SizedBox(height: 8,),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                      SizedBox(height: 8,),
                      Text("\$${product.price}",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w800),),
                      Spacer(),
                      Container(
                        ...
                        child: IncDecButton(onTap: (int count){},isColorShouldChange: true,),
                      )
                    ],),
